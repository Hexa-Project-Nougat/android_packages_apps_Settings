...
public class KangDroidTabViewTesting extends FragmentActivity implements
...
//            fragment.setArguments(args);
	...
	public static class KangDroidTestFragment extends SettingsPreferenceFragment {
		/**
		...
		*/
		...
		{
			super.onCreate(savedInstanceState);
			addPreferencesFromResource(R.xml.kdp_settings_test);
		}
	    @Override
	    protected int getMetricsCategory() {
	        return MetricsEvent.KANGDROID;
