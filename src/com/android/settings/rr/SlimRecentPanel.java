...
public class SlimRecentPanel extends /*Slim*/SettingsPreferenceFragment implements /*DialogCreatable,*/
    ...
    private KangDroidSeekBarPreference mMaxApps;
    private SystemSettingSwitchPreference mRecentPanelLeftyMode;
    private KangDroidSeekBarPreference mRecentPanelScale;
    ...
    private void initializeAllPreferences() {
        ...
        mMaxApps = (KangDroidSeekBarPreference) findPreference(RECENTS_MAX_APPS);
        ...
        mRecentPanelScale =
                (KangDroidSeekBarPreference) findPreference(RECENT_PANEL_SCALE);
