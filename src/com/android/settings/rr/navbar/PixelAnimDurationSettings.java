...
public class PixelAnimDurationSettings extends SettingsPreferenceFragment implements
    ...
    private KangDroidSeekBarPreference mPixelx;
    private KangDroidSeekBarPreference mPixely;
    private KangDroidSeekBarPreference mCollapse;
    private KangDroidSeekBarPreference mBg;
    private KangDroidSeekBarPreference mRetract;
    private KangDroidSeekBarPreference mDiamond;
    private KangDroidSeekBarPreference mDots;
    private KangDroidSeekBarPreference mHome;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mPixelx =
                (KangDroidSeekBarPreference) findPreference(PIXEL_X);
        ...
        mPixely =
                (KangDroidSeekBarPreference) findPreference(PIXEL_Y);
        ...
        mCollapse =
                (KangDroidSeekBarPreference) findPreference(PIXEL_COLLAPSE);
        ...
        mBg =
               (KangDroidSeekBarPreference) findPreference(PIXEL_BG);
        ...
        mRetract =
                (KangDroidSeekBarPreference) findPreference(PIXEL_RETRACT);
        ...
        mDiamond =
                (KangDroidSeekBarPreference) findPreference(PIXEL_DIAMOND);
        ...
        mDots =
                (KangDroidSeekBarPreference) findPreference(PIXEL_DOTS);
        ...
        mHome =
                (KangDroidSeekBarPreference) findPreference(PIXEL_HOME);
