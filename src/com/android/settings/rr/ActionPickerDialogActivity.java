    ...
    public Dialog createDialog(final Context context, final int id) {
            ...
            public void onClick(DialogInterface dialog, int item) {
                switch (id) {
                    case DIALOG_ROOT:
                        ...
                        break;
                    case DIALOG_SYSTEM:
					Log.d("ActionPickerDialogActivity", "case DIALOG_SYSTEM occured nd getting action.");
                        sendResultAndFinish(mCustomActionListAdapter.getItem(item).getAction());
					Log.d("ActionPickerDialogActivity", "getItem.getAction Called");
                        finish();
                        break;
                    default:
        ...
        switch (id) {
            case DIALOG_ROOT:
                ...
                break;
            case DIALOG_SYSTEM:
			Log.d("ActionPickerDialogActivity", "Dialog System Called");
